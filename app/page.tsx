  ...
  return (
    <main className="min-h-screen bg-black text-[#39FF14] p-4 md:p-10 font-mono">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b-2 border-[#39FF14] pb-6 mb-10 shadow-[0_0_20px_rgba(57,255,20,0.2)]">
        <div>
          <h1 className="text-5xl font-black tracking-tighter italic text-white shadow-[#39FF14_2px_2px]">
        ...
        <div className="mt-4 md:mt-0 flex flex-col items-end">
          <div className="flex items-center gap-3 bg-[#39FF14]/10 px-4 py-2 border border-[#39FF14]">
            ...
            <span className="text-[10px] font-bold uppercase">Radar Active</span>
          </div>
        </div>
      </div>
      ...
      {loading ? (
        <div className="flex flex-col justify-center items-center h-64">
          <p className="text-xl tracking-widest animate-pulse font-black">CONNECTING SATELLITE...</p>
        </div>
      ) : (
        <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {leads.length > 0 ? leads.map((lead: any) => (
            <div key={lead.id} className="relative bg-[#0a0a0a] border-2 border-[#39FF14]/30 p-6 hover:border-[#39FF14] transition-all">
              ...
              <h3 className="text-2xl font-black text-white mb-3 uppercase truncate">
                {lead.client_name}
              </h3>
              ...
              <div className="mb-8 relative">
                <div className="absolute -top-3 left-2 bg-black px-2 text-[#39FF14] text-[9px] font-bold border border-[#39FF14]">
                  Michael's Pitch
                </div>
                <div className="pt-4 border-t border-[#39FF14]/50">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button 
                  ...
                  className="border-2 border-[#39FF14] text-[#39FF14] py-3 text-[10px] font-black uppercase hover:bg-[#39FF14]/10 transition-all">
                  Copy Pitch
                </button>
              </div>
            </div>
          )) : (
            <div className="col-span-full border-2 border-dashed border-[#39FF14]/20 py-32 text-center">
              <p className="text-2xl font-black uppercase tracking-[0.4em] opacity-40">Scanning Markets...</p>
            </div>
          )}
        </div>
      )}
